# ADR 152: test(e2e): expand synthetic deposit-to-settlement integration test harness

## Context
This ADR addresses issue #152: test(e2e): expand synthetic deposit-to-settlement integration test harness.
