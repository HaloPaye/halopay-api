# ADR 163: security(auth): add geographic IP rate-limiting via MaxMind GeoIP

## Context
This ADR addresses issue #163: security(auth): add geographic IP rate-limiting via MaxMind GeoIP.
